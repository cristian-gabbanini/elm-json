...
var author$project$Api$httpGetString = F2(
	function (url, message) {
		return elm$http$Http$get(
			{
				expect: elm$http$Http$expectString(message),
				url: url
			});
	});
...
var author$project$Main$noSubscriptions = function (model) {
	return elm$core$Platform$Sub$none;
};
var author$project$Api$Review = F3(
	function (content, author, authorLocation) {
		return {author: author, authorLocation: authorLocation, content: content};
	});
var elm$json$Json$Decode$field = _Json_decodeField;
var elm$json$Json$Decode$map3 = _Json_map3;
var elm$json$Json$Decode$string = _Json_decodeString;
var author$project$Api$reviewDecoder = A4(
	elm$json$Json$Decode$map3,
	author$project$Api$Review,
	...
	A2(elm$json$Json$Decode$field, 'author_location', elm$json$Json$Decode$string));
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Api$reviewsDecoder = A2(
...
var author$project$Api$decodeReviews = function (responseFromServer) {
	...
	if (decodedReviews.$ === 'Ok') {
		var reviewsList = decodedReviews.a;
...
var author$project$Main$update = F2(
	function (msg, model) {
		...
		if (response.$ === 'Ok') {
			...
			return _Utils_Tuple2(
				author$project$Main$Error('Something bad happened, but don\'t know why'),
				elm$core$Platform$Cmd$none);
		}
	});
...
var author$project$Main$viewError = function (str) {
	return A2(
		elm$html$Html$h1,
		_List_fromArray(
			[
...
var author$project$Main$main = elm$browser$Browser$element(
	{init: author$project$Main$init, subscriptions: author$project$Main$noSubscriptions, update: author$project$Main$update, view: author$project$Main$view});
